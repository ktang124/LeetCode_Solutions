class Solution:
    def makesquare(self, matchsticks: List[int]) -> bool:
        #first case false: sum of matchsticks is not a square
        #second case false: sum is a square but cannot make a side of perimeter//4 for everything
        #true, can make square
